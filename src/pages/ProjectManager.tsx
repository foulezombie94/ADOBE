      ...
      <section className="max-w-[1400px] mx-auto p-8 space-y-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-outline-variant/10 pb-8">
          ...
          <div className="flex gap-2">
            <button className="bg-surface-container-high hover:bg-surface-container-highest text-on-surface px-6 py-2.5 rounded-sm flex items-center gap-2 border border-outline-variant/20 transition-all font-medium text-sm cursor-pointer">
              <span className="material-symbols-outlined">file_open</span>
              Import Project
            </button>
            <button
              className="bg-gradient-to-br from-primary to-primary-container text-on-primary px-6 py-2.5 rounded-sm flex items-center gap-2 font-bold text-sm shadow-lg shadow-primary/10 hover:brightness-110 transition-all cursor-pointer"
